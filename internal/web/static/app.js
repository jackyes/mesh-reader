...
(function () {
    ...
    const AUTO_REFRESH_INTERVAL = 60; // seconds (fallback reconciliation — SSE handles real-time)
    ...
    function prependOverviewEvent(ev) {
    ...
    function updateNodeFromEvent(nodeNum, ev) {
